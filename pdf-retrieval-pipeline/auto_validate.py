...
def check_relevance(retrieved_content, correct_content, threshold=0.5):
    """
    Check if retrieved chunk contains the correct answer
...
def auto_validate_results(evaluation_file='evaluation_results.json', qbank_file='Qbank.json'):
    """
